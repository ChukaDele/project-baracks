---
name: architecture
description: Use when applying the staged architecture procedure. Apply the narrow architecture procedure and return evidence, exceptions and a bounded recommendation.
---
...
Apply the narrow architecture procedure and return evidence, exceptions and a bounded recommendation.

## Routing contract

- Positive: Apply the narrow architecture procedure and return evidence, exceptions and a bounded recommendation.
- Negative: Do not trigger for a neighbouring capability merely sharing words with architecture.
...
- Positive case must select `engineering/architecture` and produce evidence.
