---
name: worktree
description: Use when applying the staged worktree procedure. Apply the narrow worktree procedure and return evidence, exceptions and a bounded recommendation.
---
...
Apply the narrow worktree procedure and return evidence, exceptions and a bounded recommendation.

## Routing contract

- Positive: Apply the narrow worktree procedure and return evidence, exceptions and a bounded recommendation.
- Negative: Do not trigger for a neighbouring capability merely sharing words with worktree.
...
- Positive case must select `engineering/worktree` and produce evidence.
