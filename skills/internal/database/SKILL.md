---
name: database
description: Use when applying the staged database procedure. Apply the narrow database procedure and return evidence, exceptions and a bounded recommendation.
---
...
Apply the narrow database procedure and return evidence, exceptions and a bounded recommendation.

## Routing contract

- Positive: Apply the narrow database procedure and return evidence, exceptions and a bounded recommendation.
- Negative: Do not trigger for a neighbouring capability merely sharing words with database.
...
- Positive case must select `engineering/database` and produce evidence.
