---
name: ar-ap-invoice
description: Use when applying the staged ar ap invoice procedure. Investigate receivables, payables and invoice state without issuing, collecting, paying or mutating the system of record.
---
...
Investigate receivables, payables and invoice state without issuing, collecting, paying or mutating the system of record.

## Routing contract

- Positive: Investigate receivables, payables and invoice state without issuing, collecting, paying or mutating the system of record.
- Negative: Do not trigger for a neighbouring capability merely sharing words with ar ap invoice.
...
- Positive case must select `finance-accounting/ar-ap-invoice` and produce evidence.
