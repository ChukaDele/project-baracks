---
name: incident
description: Use when applying the staged incident procedure. Apply the narrow incident procedure and return evidence, exceptions and a bounded recommendation.
---
...
Apply the narrow incident procedure and return evidence, exceptions and a bounded recommendation.

## Routing contract

- Positive: Apply the narrow incident procedure and return evidence, exceptions and a bounded recommendation.
- Negative: Do not trigger for a neighbouring capability merely sharing words with incident.
...
- Positive case must select `engineering/incident` and produce evidence.
