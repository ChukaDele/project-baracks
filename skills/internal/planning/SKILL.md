---
name: planning
description: Use when applying the staged planning procedure. Apply the narrow planning procedure and return evidence, exceptions and a bounded recommendation.
---
...
Apply the narrow planning procedure and return evidence, exceptions and a bounded recommendation.

## Routing contract

- Positive: Apply the narrow planning procedure and return evidence, exceptions and a bounded recommendation.
- Negative: Do not trigger for a neighbouring capability merely sharing words with planning.
...
- Positive case must select `engineering/planning` and produce evidence.
