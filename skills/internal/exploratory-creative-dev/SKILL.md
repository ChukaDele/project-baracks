---
name: exploratory-creative-dev
description: Build experimental, Awwwards/FWA-style, heavy-motion, immersive or illustration-led web experiences after the art direction is settled. Own specialised creative execution, not generic taste selection.
---

# Exploratory Creative Development

Trigger only when the brief explicitly calls for exploratory/experimental/high-craft creative work.

**Art direction comes first.** Load `design-direction-and-taste` to settle the Design Read, surface mode, preserve/redesign decision, variance/motion/density and visual grammar. This skill then executes that chosen world at a high craft bar.

1. Study 5–10 exceptional relevant references through `competitive-product-audit`; reverse-engineer composition, typography, pacing, motion, transitions, interaction, illustration/3D and sound where relevant. Do not clone surface decoration.
