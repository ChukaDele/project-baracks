---
name: staged-quality-controls
description: Use when applying the staged staged quality controls procedure. Apply the narrow staged quality controls procedure and return evidence, exceptions and a bounded recommendation.
---

# staged-quality-controls

## Mission

Apply the narrow staged quality controls procedure and return evidence, exceptions and a bounded recommendation.

## Routing contract

- Positive: Apply the narrow staged quality controls procedure and return evidence, exceptions and a bounded recommendation.
- Negative: Do not trigger for a neighbouring capability merely sharing words with staged quality controls.
...
- Positive case must select `quality/staged-quality-controls` and produce evidence.
