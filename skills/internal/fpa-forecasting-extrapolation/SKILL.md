---
name: fpa-forecasting-extrapolation
description: Use when applying the staged fpa forecasting extrapolation procedure. Build assumption-labelled forecasts from sufficient history using deterministic calculations.
---

# fpa-forecasting-extrapolation

## Mission

Build assumption-labelled forecasts from sufficient history using deterministic calculations.

## Routing contract

- Positive: Build assumption-labelled forecasts from sufficient history using deterministic calculations.
- Negative: Do not trigger for a neighbouring capability merely sharing words with fpa forecasting extrapolation.
...
- Positive case must select `finance-accounting/fpa-forecasting-extrapolation` and produce evidence.
