---
name: frontend
description: Use when applying the staged frontend procedure. Apply the narrow frontend procedure and return evidence, exceptions and a bounded recommendation.
---
...
Apply the narrow frontend procedure and return evidence, exceptions and a bounded recommendation.

## Routing contract

- Positive: Apply the narrow frontend procedure and return evidence, exceptions and a bounded recommendation.
- Negative: Do not trigger for a neighbouring capability merely sharing words with frontend.
...
- Positive case must select `engineering/frontend` and produce evidence.
