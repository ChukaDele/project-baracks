---
name: deployment
description: Use when applying the staged deployment procedure. Apply the narrow deployment procedure and return evidence, exceptions and a bounded recommendation.
---
...
Apply the narrow deployment procedure and return evidence, exceptions and a bounded recommendation.

## Routing contract

- Positive: Apply the narrow deployment procedure and return evidence, exceptions and a bounded recommendation.
- Negative: Do not trigger for a neighbouring capability merely sharing words with deployment.
...
- Positive case must select `engineering/deployment` and produce evidence.
