---
name: tdd
description: Use when applying the staged tdd procedure. Apply the narrow tdd procedure and return evidence, exceptions and a bounded recommendation.
---
...
Apply the narrow tdd procedure and return evidence, exceptions and a bounded recommendation.

## Routing contract

- Positive: Apply the narrow tdd procedure and return evidence, exceptions and a bounded recommendation.
- Negative: Do not trigger for a neighbouring capability merely sharing words with tdd.
...
- Positive case must select `engineering/tdd` and produce evidence.
