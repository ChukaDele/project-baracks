---
name: integration
description: Use when applying the staged integration procedure. Apply the narrow integration procedure and return evidence, exceptions and a bounded recommendation.
---
...
Apply the narrow integration procedure and return evidence, exceptions and a bounded recommendation.

## Routing contract

- Positive: Apply the narrow integration procedure and return evidence, exceptions and a bounded recommendation.
- Negative: Do not trigger for a neighbouring capability merely sharing words with integration.
...
- Positive case must select `engineering/integration` and produce evidence.
