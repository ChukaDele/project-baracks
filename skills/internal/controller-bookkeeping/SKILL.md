---
name: controller-bookkeeping
description: Use when applying the staged controller bookkeeping procedure. Classify accounting evidence and prepare reviewable bookkeeping proposals while the ledger owns posting and arithmetic.
---
...
Classify accounting evidence and prepare reviewable bookkeeping proposals while the ledger owns posting and arithmetic.

## Routing contract

- Positive: Classify accounting evidence and prepare reviewable bookkeeping proposals while the ledger owns posting and arithmetic.
- Negative: Do not trigger for a neighbouring capability merely sharing words with controller bookkeeping.
...
- Positive case must select `finance-accounting/controller-bookkeeping` and produce evidence.
