---
name: observability
description: Use when applying the staged observability procedure. Apply the narrow observability procedure and return evidence, exceptions and a bounded recommendation.
---
...
Apply the narrow observability procedure and return evidence, exceptions and a bounded recommendation.

## Routing contract

- Positive: Apply the narrow observability procedure and return evidence, exceptions and a bounded recommendation.
- Negative: Do not trigger for a neighbouring capability merely sharing words with observability.
...
- Positive case must select `engineering/observability` and produce evidence.
