---
name: auth-security
description: Use when applying the staged auth security procedure. Apply the narrow auth security procedure and return evidence, exceptions and a bounded recommendation.
---
...
Apply the narrow auth security procedure and return evidence, exceptions and a bounded recommendation.

## Routing contract

- Positive: Apply the narrow auth security procedure and return evidence, exceptions and a bounded recommendation.
- Negative: Do not trigger for a neighbouring capability merely sharing words with auth security.
...
- Positive case must select `engineering/auth-security` and produce evidence.
