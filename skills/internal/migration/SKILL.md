---
name: migration
description: Use when applying the staged migration procedure. Apply the narrow migration procedure and return evidence, exceptions and a bounded recommendation.
---
...
Apply the narrow migration procedure and return evidence, exceptions and a bounded recommendation.

## Routing contract

- Positive: Apply the narrow migration procedure and return evidence, exceptions and a bounded recommendation.
- Negative: Do not trigger for a neighbouring capability merely sharing words with migration.
...
- Positive case must select `engineering/migration` and produce evidence.
