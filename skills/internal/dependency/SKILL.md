---
name: dependency
description: Use when applying the staged dependency procedure. Apply the narrow dependency procedure and return evidence, exceptions and a bounded recommendation.
---
...
Apply the narrow dependency procedure and return evidence, exceptions and a bounded recommendation.

## Routing contract

- Positive: Apply the narrow dependency procedure and return evidence, exceptions and a bounded recommendation.
- Negative: Do not trigger for a neighbouring capability merely sharing words with dependency.
...
- Positive case must select `engineering/dependency` and produce evidence.
