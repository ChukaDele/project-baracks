---
name: performance
description: Use when applying the staged performance procedure. Apply the narrow performance procedure and return evidence, exceptions and a bounded recommendation.
---
...
Apply the narrow performance procedure and return evidence, exceptions and a bounded recommendation.

## Routing contract

- Positive: Apply the narrow performance procedure and return evidence, exceptions and a bounded recommendation.
- Negative: Do not trigger for a neighbouring capability merely sharing words with performance.
...
- Positive case must select `engineering/performance` and produce evidence.
