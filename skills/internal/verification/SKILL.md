---
name: verification
description: Use when applying the staged verification procedure. Apply the narrow verification procedure and return evidence, exceptions and a bounded recommendation.
---
...
Apply the narrow verification procedure and return evidence, exceptions and a bounded recommendation.

## Routing contract

- Positive: Apply the narrow verification procedure and return evidence, exceptions and a bounded recommendation.
- Negative: Do not trigger for a neighbouring capability merely sharing words with verification.
...
- Positive case must select `engineering/verification` and produce evidence.
