...
describe('Major coordinator contract', () => {
  ...
  it('keeps the product goal while loading durable project and correction learnings', () => {
    ...
    expect(prompt).toContain('Reuse the existing project, validated capability, maintained library or skill before building a new subsystem');
    ...
    expect(prompt).toContain('FAST checks while iterating, acceptance evidence for the critical path');
