...
const pinnedRuntimePeersSchema = z
  .object({
    packages: z
      .object({
        react: z.literal('18.3.1'),
        'react-dom': z.literal('18.3.1'),
      })
      .strict(),
    integrities: z
      .object({
        react: npmIntegrity,
        'react-dom': npmIntegrity,
      })
      .strict(),
  })
  .strict();
  ...
  .object({
    ...
    npm: z
      .object({
        ...
        runtimePeers: pinnedRuntimePeersSchema,
  ...
  npm: {
    ...
    integrities: {
      ...
      '@deepseek-ai/dsh-subagent-codex':
        'sha512-lp/2sM/Y2V7VEGsE34C3zeQ11N5sYI9TkvfppJFGH6fGI8/PCSfKwLobRWhQc3nG5jYO2PooJvZi9I8JHfNmnA==',
